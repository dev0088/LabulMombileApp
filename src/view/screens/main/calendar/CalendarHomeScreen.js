...
const styles = {
  ...
  dateNameStyle: { color: '#BFCDDB', marginBottom: 16 * em, fontSize: 13 * em, fontFamily: 'Lato-Bold' },
  highlightDateNumberStyle: { color: '#1E2D60', width: 30 * em, fontSize: 16 * em, fontFamily: 'Lato-Regular' },
